...
export function LoginModal({ isOpen, onClose, onSuccess }: LoginModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const effectiveRole: UserRole = cleanInput.toLowerCase() === 'admin' ? 'ADMIN' : requestedRole;
      const result = await authenticateUserAsync(cleanInput, cleanPassword, effectiveRole);
